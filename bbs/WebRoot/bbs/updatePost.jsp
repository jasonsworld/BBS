...
<DIV><BR/>
	...
	<DIV>
		<FORM name="updateForm" onSubmit="return check();" action="doUpdatePost.jsp" method="post">
			...
			<DIV class="t">
				<TABLE cellSpacing="0" cellPadding="0" align="center">
				    ...
				    <TR class="tr3">
					    ...
					    <TH><INPUT name="title" value="<%=title %>" class="input" style="PADDING-LEFT: 2px; FONT: 14px Tahoma" tabIndex="1" size="60"></TH>
				    </TR>
				    ...
				    <TR class="tr3">
					    ...
					    <TH colSpan="2">
					        <DIV>
						        <span><textarea  name="content" style="WIDTH: 500px;" rows="20" cols="90" tabIndex="2" ><%=content %></textarea></span>
						    </DIV>
